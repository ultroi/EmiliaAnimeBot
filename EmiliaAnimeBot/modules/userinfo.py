...
def info(update: Update, context: CallbackContext):
    ...
    if user.id == OWNER_ID:
        text += "\n\nThe Ranking of The Person is Owner"
        disaster_level_present = True
    elif user.id in DEV_USERS:
        text += "\n\nThis Person is a Developer of Pikachu"
        disaster_level_present = True
    elif user.id in DRAGONS:
        text += "\n\nThis Person is a Sudo-User of Pikachu"
        disaster_level_present = True
    elif user.id in DEMONS:
        text += "\n\nThis Person is a Support User of Pikachu"
        disaster_level_present = True
    elif user.id in TIGERS:
        text += "\n\nThis User is Immune to all Restrictions over Pikachu"
        disaster_level_present = True
